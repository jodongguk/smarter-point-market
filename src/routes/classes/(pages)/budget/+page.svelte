...
<div class="flex flex-col space-y-4 p-4 --color-surface-400">

    <button class="bg-point-market-purple2 text-white p-3.5 w-full rounded-lg tracking-wide font-bold font-display" on:click={budgetWriteDrawer}>
        + 신규예산등록
    </button>
